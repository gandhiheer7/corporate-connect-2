document.addEventListener("DOMContentLoaded", () => {
  ...
  // --- REMOVED: All old image pre-loading logic ---

  // Activities data structure
  const activities = [
    { id: "mind-1", name: "Mindfulness with Forest Bathing", isCeoDinner: false, img: "https://placehold.co/400x250/22c55e/white?text=Forest+Bathing" },
    { id: "mind-2", name: "Mindfulness with Art Based Therapy", isCeoDinner: false, img: "https://placehold.co/400x250/3b82f6/white?text=Art+Therapy" },
    { id: "mind-3", name: "Mindfulness with Eating", isCeoDinner: false, img: "https://placehold.co/400x250/8b5cf6/white?text=Mindful+Eating" },
    { id: "mind-4", name: "Mindfulness with Sound", isCeoDinner: false, img: "https://placehold.co/400x250/ec4899/white?text=Sound+Bath" },
    { id: "mind-5", name: "De-stress Walk", isCeoDinner: false, img: "https://placehold.co/400x250/f97316/white?text=De-stress+Walk" },
    { id: "mind-6", name: "CEO/Director's Curated Dinner", isCeoDinner: true, img: "https://placehold.co/400x250/eab308/white?text=CEO+Dinner" },
  ];
  ...
  // NEW: Render the 6 package cards
  ...
  proposalForm.addEventListener("submit", (e) => {
    ...
    // --- NEW ROBUST FIX: Load the image on demand ---
    const headerImg = new Image();
    // This path must be correct! Assumes 'images' folder is in the same directory as index.html
    headerImg.src = 'images/pdf-header.png'; 
    
    headerImg.onload = () => {
        // Image is now loaded and ready to be used
        try {
            const doc = new jsPDF();
    ...
    // This handles if the image fails to load (e.g., wrong path)
    headerImg.onerror = () => {
        console.error("Failed to load PDF header image. Check the path in script.js.");
        showMessage("Sorry, there was an error loading proposal assets. Please try again.", "error");
        finalSubmitBtn.disabled = false;
        finalSubmitBtn.textContent = 'Submit';
    };
    // --- END OF NEW LOGIC ---
